package com.alclabs.fasttablelayout
...
class FastTableLayout (private val context: Context,
    ...
    var SET_DEFAULT_HEADER_BACKGROUND = false

    private var SET_CUSTOM_HEADER_BORDER = false
    private var CUSTOM_DRAWABLE_HEADER_BORDER = -1

    private var SET_CUSTOM_HEADER_BACKGROUND = false
   ...
   fun build(){
       ...
       if(SET_CUSTOM_HEADER_BACKGROUND){
           tableRow0.setBackgroundResource(CUSTOM_HEADER_BACKGROUND_COLOR)
       }
       headers.forEach {
